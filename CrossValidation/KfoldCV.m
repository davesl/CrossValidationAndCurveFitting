function [CV, norm_mse_test, norm_mse_train] = KfoldCV(X,Y,Model,Nfolds,Nbins)
...
% function: [fitresult, gof] = Poly2Fit(XX, YY,0);
...
for i=1:Nfolds
    ...
    eval(['[fitresult, gof] = ' Model '(XTrain, YTrain,0);']);
